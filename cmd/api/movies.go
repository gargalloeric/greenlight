...
func (app *application) deleteMovieHandler(w http.ResponseWriter, r *http.Request) {
	...
	if err := app.writeJSON(w, http.StatusOK, envelop{"message": "movie was successfully deleted"}, nil); err != nil {
		app.serverErrorResponse(w, r, err)
	}
}
...
func (app *application) listMoviesHandler(w http.ResponseWriter, r *http.Request) {
	...
	if err := app.writeJSON(w, http.StatusOK, envelop{"movies": movies, "metadata": metadata}, nil); err != nil {
		app.serverErrorResponse(w, r, err)
	}
}
